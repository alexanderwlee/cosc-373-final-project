...
(i.e., a \emph{message}) of an arbitrary size and outputs a bit array (i.e.,
\emph{hash}) of a fixed size. In the case of the SHA256 cryptographic hash
function, the hash has a length of 256 bits.
